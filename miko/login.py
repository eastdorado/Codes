...
class LoginPage(QtWidgets.QWidget):
    def __init__(self, *args, **kwargs):
        ...
        # region 登录页面
        logo = QtGui.QIcon(r'/res/images/569942.gif')
        ...
        self.selectApply.setIcon(QtGui.QIcon(r'/res/images/569970.gif'))
...
class LoginWin(QtWidgets.QFrame):
    def __init__(self, *args, **kwargs):
        ...
        icon.setIcon(QtGui.QIcon(r'/res/images/1126157.gif'))
        ...
        setting.setIcon(QtGui.QIcon(r'/res/images/setting.gif'))
        setting.setIconSize(QtCore.QSize(30, 30))

        status = QtWidgets.QLabel('日期：')
        tt = QtWidgets.QToolButton()
        tt.setIcon(QtGui.QIcon(r'/res/images/1190300.gif'))
        bl_h_s = QtWidgets.QHBoxLayout()
        bl_h_s.addWidget(tt)
