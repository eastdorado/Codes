...
from Ui_SoftKeyBoard import Ui_SoftKeyBoard
...
class SoftKeyBoard(QWidget, Ui_SoftKeyBoard):
    ...
    def __init__(self):
        ...
        self.log = MyLog()
        self.btn_esc_.setStyleSheet('color:yellow')
        self.btn_clear_.setStyleSheet('color:skyblue')
    ...
    def mouseDoubleClickEvent(self, e):
        self.log.debug('双击了！{}'.format(e.button()))
...
def btn_{}_clicked(self):
    ...
    def resizeEvent(self, event):
        ...
        if h >= 360:
            ...
            self.setStyleSheet(self.set_style(16))
